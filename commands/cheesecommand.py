...
class CheeseCommand( commandbase.BaseCommand ):
    ...
    def __init__(self):
        ...
        self.templates = [  Template("begrudgingly serves $name $cheese."),
                            ...
                            Template("cocks his blunderbuss, fires a flan of $cheese at $name."),
                            Template("squats over $name, pushes out some recycled $cheese."),
                            Template("bangs his head on the bar. A plate of $cheese lands in $name's lap."),
                            Template("chants $cheese $cheese $cheese, which then appears in front of $name."),
                            Template("puts on some Jimmy Nail and casually places $cheese on $name's keyboard."),
                            Template("hails !satan and makes a sacrifical offering of $cheese. $name bursts into flames."),
