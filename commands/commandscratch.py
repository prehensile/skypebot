...
class StrategyCommand( BaseCommand ):
	...
	def __init__(self):
		...
		self.templates = [ "reminds $name that $strategy",
				"suggests that $name $strategy",
				"nods sagely to $name, says $strategy",
				"hints that $name may $strategy",
				"asks $name to remain calm and $strategy"]

        self.strategy = [ "A line has two sides.",  
