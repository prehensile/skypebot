...
class ChoonCommand(object):
	...
	def __init__(self):
		...
		self.templates = [ 	Template("does a rubbish swan-dive and puts on some $choon for $name"),
							...
							Template("suggest $name that they perform $choon together on the piano"),
							...
							Template("grabs $choon and swaggers of to the pantry"),
							Template("suggest $choon and mutters something about the !cheese delivery"),
							Template("drops $choon and slowly sways into a trance"),
							...
							Template("has a ponder and setlles for $choon"),
							Template("phones a friend and goes for $choon"),
							Template("snakes the snow globe and plays $choon"),
