...
class ChoonCommand(object):
	...
	def __init__(self):
		...
		self.templates = [ 	Template("does a rubbish swan-dive and puts on some $choon for $name"),
							...
							Template("picks up the guitar and plays a traditional flemenco badly."),
							...
							Template("grabs a pair of spoons and does his best Dick Van Dyke impersonation"),
							...
							Template("sings like frog for $name"),
							...
							Template("switches on his 1210s and grabs %$choon"),
